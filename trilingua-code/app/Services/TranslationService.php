...
/**
 * @deprecated Use App\Services\Translation\TranslationManager instead.
 * 
 * This service still works for backward compatibility but all new code
 * should use TranslationManager which reads config from config/translation.php
 * and communicates with the Python AI Engine through DTOs.
 * 
...
class TranslationService
{
     ...
     * 
     * @deprecated Use config('translation.python_service.url') instead.
     */
    private const SERVICE_URL = 'http://127.0.0.1:5000';

    /**
     * @deprecated Language mapping is now handled by the Python AI Engine.
     */
    ...
    /**
     * @deprecated Extension mapping is now in config('translation.extension_map').
     */
